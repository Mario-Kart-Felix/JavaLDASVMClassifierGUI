package algorithm.svm.predictor;
...
public class SVMPredictProcessor {

	private String modelFilePath;
	private String inputFilePath;
	private String outputFilePath;

	public SVMPredictProcessor(String modelFilePath, String inputFilePath, String outputFilePath) {
	...
	public void run() throws IOException {
		...
		try {
			...
			// nạp file model
			svm_model model = svm.svm_load_model(this.modelFilePath);
			...
			DataOutputStream output = new DataOutputStream(
					new BufferedOutputStream(new FileOutputStream(this.outputFilePath)));
