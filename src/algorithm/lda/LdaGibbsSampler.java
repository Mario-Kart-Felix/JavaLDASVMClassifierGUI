...
public class LdaGibbsSampler {
	...
	public void gibbs(int K, double alpha, double beta) {
		...
		System.out.println(
				"Sampling " + ITERATIONS + " iterations with burn-in of " + BURN_IN + " (B/S=" + THIN_INTERVAL + ").");
	...
	public static void main(String[] args) {
		...
		int[][] documents = { { 1, 4, 3, 2, 3, 1, 4, 3, 2, 3, 1, 4, 3, 2, 3, 6 },
				{ 2, 2, 4, 2, 4, 2, 2, 2, 2, 4, 2, 2 }, { 1, 6, 5, 6, 0, 1, 6, 5, 6, 0, 1, 6, 5, 6, 0, 0 },
				{ 5, 6, 6, 2, 3, 3, 6, 5, 6, 2, 2, 6, 5, 6, 6, 6, 0 },
				{ 2, 2, 4, 4, 4, 4, 1, 5, 5, 5, 5, 5, 5, 1, 1, 1, 1, 0 }, { 5, 4, 2, 3, 4, 5, 6, 6, 5, 4, 3, 2 } }; // 文档的词语id集合
		// vocabulary
		int V = 7; // 词表大小
		int M = documents.length;
		// # topics
